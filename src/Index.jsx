...
import { RiArrowDownFill, RiArrowUpFill, RiFacebookFill, RiInstagramFill, RiTiktokFill, RiYoutubeFill } from "react-icons/ri";
import './index.css';
    ...
    <Guest>
      <div id='atas' style={{ backgroundColor: '#2B2A2B', minHeight: '100vh' }}>
                ...
                <div className="text-white">
                  ...
                  <div className='d-flex gap-4 mt-3 mx-2 icon-index'>
                    <div className="menu-icon">
                      <a href="https://web.facebook.com/uhammadrois" className="index-icon">
                        <RiFacebookFill />
                      </a>
                    </div>
                    <div className="menu-icon">
                      <a href="https://www.instagram.com/roess___/" className="index-icon">
                        <RiInstagramFill />
                      </a>
                    </div>
                    <div className="menu-icon">
                      <a href="https://www.tiktok.com/@roisdev_?_t=8jhHW15U60m&_r=1" className="index-icon">
                        <RiTiktokFill />
                      </a>
                    </div>
                    <div className="menu-icon">
        ...
        <div className={stikyIcon ? 'hidden text-white text-end fixed-bottom p-5' : 'text-white text-end fixed-bottom p-5 stiky-icon'}>
          <a href="#atas">
            <RiArrowUpFill className='icon-atas' />
          </a>
        </div>

        <div className="d-flex text-scroll flex-column align-items-center text-white">
          <h4>Scroll Down For More <RiArrowDownFill size={25}/></h4>
